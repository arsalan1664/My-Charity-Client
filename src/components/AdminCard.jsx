...
export const Cards_ = () => {
  const { data } = useQuery(DONORS_QUERY);
  const amounts = data?.donors.map((donor) => donor.amount) || [];
  ...
  return (
    <Row gutter={16}>
      <Col span={8}>
        <Card title="Total Payment Received" bordered={true}>
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            {/* <DollarOutlined style={{ fontSize: "20px", color: "#90EE90" }} /> */}
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              height="3em"
      ...
      <Col span={8}>
        <Card title="No. of People Donated" bordered={true}>
          <div
            style={{
              display: "flex",
              alignItems: "center",
      ...
      <Col span={8}>
        <Card title="Average Amount" bordered={true}>
          <div
            style={{
              display: "flex",
              alignItems: "center",
